...
void deplacer_tuile_en_derniere_position(struct tuile_s *, int, struct tuile_s[143][143], int, int, int, int);
...
// Fais le traitement de vérification de la pose du pion sur la ville
int verif_pions_ville(struct tuile_s[143][143], int, int, int *, int);
